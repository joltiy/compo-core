...
{
    public function let(TranslatorInterface $translator, ThemeContextInterface $themeContext)
    {
    ...
    public function it_implements_translator_interface()
    {
        $this->shouldImplement(TranslatorInterface::class);
    }

    public function it_implements_translator_bag_interface()
    {
        $this->shouldImplement(TranslatorBagInterface::class);
    }

    public function it_implements_warmable_interface()
    {
        $this->shouldImplement(WarmableInterface::class);
    }

    public function it_proxies_getting_the_locale_to_the_decorated_translator(TranslatorInterface $translator)
    {
    ...
    public function it_proxies_setting_the_locale_to_the_decorated_translator(TranslatorInterface $translator)
    {
    ...
    public function it_just_proxies_translating(TranslatorInterface $translator, ThemeContextInterface $themeContext)
    {
    ...
    public function it_warms_up_if_decorated_translator_is_warmable(WarmableInterface $translator)
    {
