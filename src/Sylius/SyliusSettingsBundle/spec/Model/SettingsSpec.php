...
final class SettingsSpec extends ObjectBehavior
{
    ...
    public function its_schema_alias_is_null_by_default()
    {
        $this->getSchemaAlias()->shouldReturn(null);
    }

    public function its_schema_should_be_immutable_after_it_is_set()
    {
    ...
    public function its_namespace_is_null_by_default()
    {
    ...
    public function it_can_check_if_it_has_parameter()
    {
    ...
    public function it_can_count_its_parameters()
    {
