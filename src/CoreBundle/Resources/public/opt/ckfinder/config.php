...
function CheckAuthentication()
{
    ...
    return isset($_COOKIE['mindy_auth']) && $_COOKIE['mindy_auth'];
...
$config['licenseName'] = 'walkmanrd';
$config['licenseKey']  = 'LTDUW9FXQ8MCKV4X9U4J2T1PVQ5FH1UH';
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => '/userfiles/',
    'root'         => $_SERVER['DOCUMENT_ROOT'] . '/userfiles/',
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
