    ...
    angular.module('app.seo', ['yandex-metrika', 'angulartics',  'ngResource'])
        ...
        .config(['$analyticsProvider', function ($analyticsProvider) {
            ...
            var getClientsId = function() {
                ...
                var match_ga = document.cookie.match('(?:^|;)\\s*_ga=([^;]*)');

                var raw_ga = (match_ga) ? decodeURIComponent(match_ga[1]) : null;

                if (raw_ga) {
                    match_ga = raw_ga.match(/(\d+\.\d+)$/);
                }

                var gacid = (match_ga) ? match_ga[1] : null;
